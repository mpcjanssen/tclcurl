...
PKG_SOURCES	=  tclcurl.c
PKG_OBJECTS	=  tclcurl.o
...
PKG_LIB_FILE	= libtcl9curl0.1.so
PKG_LIB_FILE8	= libcurl0.1.so
PKG_LIB_FILE9	= libtcl9curl0.1.so
PKG_STUB_LIB_FILE = libcurlstub.a
...
top_builddir	= /home/mpcjanssen/Src/tclcurl
...
SHLIB_LD_LIBS	= ${LIBS} -L/opt/tcl/lib -ltclstub
STLIB_LD	= ${AR} cr
...
TCL_BIN_DIR	= /opt/tcl/lib
TCL_SRC_DIR	= /home/mpcjanssen/Src/tcl9.0.1
...
TCLSH_PROG	= /opt/tcl/bin/tclsh9.0
...
INCLUDES	=  -I"/opt/tcl/include" -I.
#INCLUDES	=  -I"/opt/tcl/include" @TK_INCLUDES@ @TK_XINCLUDES@
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"curl\" -DPACKAGE_TARNAME=\"curl\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"curl\ 0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_curl=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"curl\" -DPACKAGE_TARNAME=\"curl\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"curl\ 0.1\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_curl=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 $(PKG_CFLAGS)
